...
namespace UtilityControl.Common
{
    public static class ControlAttachProperty
    {
        ...
        public static readonly DependencyProperty LanguageTextProperty = DependencyProperty.RegisterAttached(
            "LanguageText", typeof(string), typeof(ControlAttachProperty), new FrameworkPropertyMetadata(string.Empty, OnLanguageTextChanged));

        public static void SetLanguageText(DependencyObject element, string value)
        {
            element.SetValue(LanguageTextProperty, value);
        }

        public static string GetLanguageText(DependencyObject element)
        {
            return (string)element.GetValue(LanguageTextProperty);
        }
        ...
        #region UIconProperty 字体图标
        /// <summary>
        /// 字体图标
        /// </summary>
        public static readonly DependencyProperty UIconProperty = DependencyProperty.RegisterAttached(
            "UIcon", typeof(string), typeof(ControlAttachProperty), new FrameworkPropertyMetadata(""));

        public static string GetUIcon(DependencyObject d)
        {
            return (string)d.GetValue(UIconProperty);
        }

        public static void SetUIcon(DependencyObject obj, string value)
        {
            obj.SetValue(UIconProperty, value);
        }
        #endregion

        #region UIconSizeProperty 字体图标大小
        /// <summary>
        /// 字体图标
        /// </summary>
        public static readonly DependencyProperty UIconSizeProperty = DependencyProperty.RegisterAttached(
            "UIconSize", typeof(double), typeof(ControlAttachProperty), new FrameworkPropertyMetadata(12D));

        public static double GetUIconSize(DependencyObject d)
        {
            return (double)d.GetValue(UIconSizeProperty);
        }

        public static void SetUIconSize(DependencyObject obj, double value)
        {
            obj.SetValue(UIconSizeProperty, value);
        }
        #endregion

        #region UIconMarginProperty 字体图标边距
        /// <summary>
        /// 字体图标
        /// </summary>
        public static readonly DependencyProperty UIconMarginProperty = DependencyProperty.RegisterAttached(
            "UIconMargin", typeof(Thickness), typeof(ControlAttachProperty), new FrameworkPropertyMetadata(null));

        public static Thickness GetUIconMargin(DependencyObject d)
        {
            return (Thickness)d.GetValue(UIconMarginProperty);
        }

        public static void SetUIconMargin(DependencyObject obj, Thickness value)
        {
            obj.SetValue(UIconMarginProperty, value);
        }
        #endregion
        ...
        private static void OpenFileButtonClick(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            string filter =string.IsNullOrEmpty(txt?.Tag+"")? "所有文件(*.*)|*.*":txt?.Tag+"";
